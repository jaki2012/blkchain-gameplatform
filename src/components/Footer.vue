                ...
                <!-- <div class="row">
                    ...
                    <div class="4u 12u(mobile)">
                        <section>
                            ...
                            <a href="#" class="image featured"><img src="../assets/template/images/pic10.jpg" alt="" /></a>
                            <p>
                                This is <strong>Dopetrope</strong> a free, fully responsive HTML5 site template by
                                <a rel="nofollow" href="http://twitter.com/ajlkn">AJ</a> for <a rel="nofollow" href="http://html5up.net/">HTML5 UP</a> It's released for free under
                                the <a rel="nofollow" href="http://html5up.net/license/">Creative Commons Attribution</a> license so feel free to use it for any personal or commercial project &ndash; just don't forget to credit us!
                            </p>
                            <footer>
...
<style scoped>
  ...
  /* Grid */
    ...
    @media screen and (min-width: 737px) and (max-width: 1200px) {
        ...
        .\31 2u\(tablet\), .\31 2u\24\(tablet\) {
            width: 100%;
            clear: none;
            margin-left: 0;
        }

        .\31 1u\(tablet\), .\31 1u\24\(tablet\) {
            width: 91.6666666667%;
            clear: none;
            margin-left: 0;
        }

        .\31 0u\(tablet\), .\31 0u\24\(tablet\) {
            width: 83.3333333333%;
            clear: none;
            margin-left: 0;
        }

        .\39 u\(tablet\), .\39 u\24\(tablet\) {
            width: 75%;
            clear: none;
            margin-left: 0;
        }

        .\38 u\(tablet\), .\38 u\24\(tablet\) {
            width: 66.6666666667%;
            clear: none;
            margin-left: 0;
        }

        .\37 u\(tablet\), .\37 u\24\(tablet\) {
            width: 58.3333333333%;
            clear: none;
            margin-left: 0;
        }

        .\36 u\(tablet\), .\36 u\24\(tablet\) {
            width: 50%;
            clear: none;
            margin-left: 0;
        }

        .\35 u\(tablet\), .\35 u\24\(tablet\) {
            width: 41.6666666667%;
            clear: none;
            margin-left: 0;
        }

        .\34 u\(tablet\), .\34 u\24\(tablet\) {
            width: 33.3333333333%;
            clear: none;
            margin-left: 0;
        }

        .\33 u\(tablet\), .\33 u\24\(tablet\) {
            width: 25%;
            clear: none;
            margin-left: 0;
        }

        .\32 u\(tablet\), .\32 u\24\(tablet\) {
            width: 16.6666666667%;
            clear: none;
            margin-left: 0;
        }

        .\31 u\(tablet\), .\31 u\24\(tablet\) {
            width: 8.3333333333%;
            clear: none;
            margin-left: 0;
        }
